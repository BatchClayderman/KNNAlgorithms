...
kNNResultsFilepath = "kNNFMBRResults.txt"
...
def printHelp() -> None:
	print("Python script for KNN fundamental MBR querying based on RTree. ", end = "\n\n")
	print("Option: ")
	...
	print("Format: ")
	print("\tpython kNNFMBRQuerying.py [/rTree|--rTree|rTree] rTreeFilepath [/kNNQueries|--kNNQueries|kNNQueries] kNNQueriesFilepath [/k|-k|k] k [/o|-o|o|/output|--output|output] outputFilepath", end = "\n\n")
	print("Example: ")
	print("\tpython kNNFMBRQuerying.py /rTree Rtree.txt /kNNQueries NNqueries.txt /k 10")
	print("\tpython kNNFMBRQuerying.py /rTree Rtree.txt /kNNQueries NNqueries.txt /k 10 /output kNNResults.txt", end = "\n\n")
